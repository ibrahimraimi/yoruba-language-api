...
description: Guide to the CI/CD pipeline and Docker environment for the Yoruba API
---

This document provides a comprehensive guide to the CI/CD pipeline and Docker containerization setup for the Yoruba API.
...
```bash
# Build image
docker build -f infra/docker/Dockerfile -t yoruba-api .

# Run container
docker run -p 8000:8000 yoruba-api
```
...
**This setup provides a production-ready, scalable, and maintainable infrastructure for the Yoruba API.**
