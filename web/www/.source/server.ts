...
export const docs = await create.docs("docs", "content/docs", {}, {"api.mdx": __fd_glob_0, "cli.mdx": __fd_glob_1, "configuration.mdx": __fd_glob_2, "development.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, "installation.mdx": __fd_glob_5, });